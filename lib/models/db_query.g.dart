...
DbQuery _$DbQueryFromJson(Map<String, dynamic> json) => DbQuery(
  ...
  (json['orderColumnIndex'] as num?)?.toInt(),
  json['time'] == null
      ? null
  ...
  (json['columns'] as List<dynamic>?)
      ?.map(
        (e) => QueriesRequestElementColumn.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  (json['filters'] as List<dynamic>?)
      ?.map(
        (e) => QueriesRequestElementFilter.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
);
