...
SmartServiceExtendedParameter _$SmartServiceExtendedParameterFromJson(
  ...
  (json['options'] as List<dynamic>?)
      ?.map(
        (e) => SmartServiceParameterOption.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  json['type'] as String,
  json['value_label'] as String?,
  ...
  json['characteristic'] == null
      ? null
      : Characteristic.fromJson(json['characteristic'] as Map<String, dynamic>),
...
SmartServiceInstance _$SmartServiceInstanceFromJson(
  ...
  (json['parameters'] as List<dynamic>?)
      ?.map((e) => SmartServiceParameter.fromJson(e as Map<String, dynamic>))
      .toList(),
